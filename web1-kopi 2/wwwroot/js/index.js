...
function HentalleStrekning() {
    $.get("Home/HentalleStrekning", function (strekninger) {
...
function formaterStrekninger(strekninger) {
    let ut = "<table class='table table-striped'>" +
        "<tr>" +
        "<th>Fra</th><th>Til</th><th></th><th></th>" +
        "</tr>";
    for (let strekning of strekninger) {
        ut += "<tr>" +
            ...
            "<td> <a class='btn btn-primary' href='endre.html?id=" + strekning.SId + "'>Endre</a></td>" +
            "<td> <button class='btn btn-danger' onclick='slettStrekning(" + strekning.SId + ")'>Slett</button></td>" +
            "</tr>";
    }
    ut += "</table>";
    $("#billetene").html(ut);
...
function slettStrekning(SId) {
    const url = "Home/slettStrekning?id=" + SId;
